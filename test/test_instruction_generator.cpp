...
int main() {
    ...
    //ADD R0 4
    unsigned long ins2 = (base::_generate_instruction(INSTRUCTION_ADD, INSTRUCTION_TYPE) |
                        base::_generate_instruction(ADDRESS_REGISTER, OPERATE_NUMBER_1_ADDRESS_METHOD) |
                        base::_generate_instruction(REGISTER_0, OPERATE_NUMBER_1) |
                        base::_generate_instruction(ADDRESS_NUMBER, OPERATE_NUMBER_2_ADDRESS_METHOD) |
                        base::_generate_instruction(4, OPERATE_NUMBER_2));
    //ig(ins2);
    //ig.debug();

    //ADD C R0
    unsigned long ins3 = (base::_generate_instruction(INSTRUCTION_ADD, INSTRUCTION_TYPE) |
                        base::_generate_instruction(ADDRESS_REGISTER, OPERATE_NUMBER_1_ADDRESS_METHOD) |
                        base::_generate_instruction(REGISTER_C, OPERATE_NUMBER_1) |
                        base::_generate_instruction(ADDRESS_REGISTER, OPERATE_NUMBER_2_ADDRESS_METHOD) |
                        base::_generate_instruction(REGISTER_0, OPERATE_NUMBER_2));
    //ig(ins3);
    //ig.debug();
    ...
    unsigned long ins4 = (base::_generate_instruction(INSTRUCTION_MOV, INSTRUCTION_TYPE) |
                        base::_generate_instruction(ADDRESS_NUMBER, OPERATE_NUMBER_1_ADDRESS_METHOD) |
                        base::_generate_instruction(4, OPERATE_NUMBER_1) |
                        base::_generate_instruction(ADDRESS_MEMORY, OPERATE_NUMBER_2_ADDRESS_METHOD) |
                        base::_generate_instruction(0b000000001000, OPERATE_NUMBER_2));
    ig(ins4);

    //ADD R0 memory
    unsigned long ins5 = (base::_generate_instruction(INSTRUCTION_ADD, INSTRUCTION_TYPE) |
                        base::_generate_instruction(ADDRESS_REGISTER, OPERATE_NUMBER_1_ADDRESS_METHOD) |
                        base::_generate_instruction(REGISTER_0, OPERATE_NUMBER_1) |
                        base::_generate_instruction(ADDRESS_MEMORY, OPERATE_NUMBER_2_ADDRESS_METHOD) |
                        base::_generate_instruction(0b000000001000, OPERATE_NUMBER_2));
